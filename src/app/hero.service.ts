...
export class HeroService {
  ...
  getHeroes(): Observable<Hero[]> {
    ...
    .pipe(
      tap(_ => this.log('fetched heroes')), //tap() operator enables this ability by looking at the observable values, doing something with those values, and passing them along. The tap() call back doesn't access the values themselves.
